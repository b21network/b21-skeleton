...
RUN hab pkg exec core/coreutils mkdir -p '/hab/svc/mysql/data' '/hab/svc/b21-skeleton/data' '/hab/svc/nginx/files' \
    && hab pkg exec core/coreutils chown hab:hab -R '/hab/svc/mysql/data' '/hab/svc/b21-skeleton/data' '/hab/svc/nginx/files'

VOLUME ["/hab/svc/mysql/data", "/hab/svc/b21-skeleton/data", "/hab/svc/nginx/files"]


# configure entrypoint
ENTRYPOINT ["hab", "sup", "run"]
CMD ["slate/b21-skeleton-composite"]
